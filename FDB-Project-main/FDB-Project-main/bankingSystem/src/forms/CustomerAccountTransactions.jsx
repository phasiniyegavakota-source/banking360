...
const CustomerAccountTransactions = () => {
    ...
    const fetchTransactions = async (userId) => {
        try {
            const response = await axios.get(`http://localhost:5001/accountTransactions/${userId}`);
    ...
    return (
        <div className="max-w-4xl mx-auto p-6 bg-white shadow-lg rounded-lg">
            <h2 className="text-2xl font-bold mb-4 text-center">Account Transactions</h2>
                    ...
                    <table className="min-w-full table-fixed bg-white">
                        <thead>
                            <tr>
                                ...
                                <th className="w-1/12 py-2 px-4 bg-gray-200 text-gray-600 border-b border-gray-200">Description</th>
                        ...
                        <tbody>
                            {transactions.map((transaction) => (
                                <tr key={transaction.Transaction_ID}>
                                    ...
                                    <td className="py-2 px-4 border-b border-gray-200">{transaction.Account_ID}</td>
...
export default CustomerAccountTransactions;
